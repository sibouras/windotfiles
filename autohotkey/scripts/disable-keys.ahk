...
; source: https://www.autohotkey.com/boards/viewtopic.php?f=6&t=33925
...
!F3::hk(1,1,"KEYBOARD MOUSE AND SCREEN LOCKED! - ALT+F2 TO UNLOCK",,,1,"black") ; Disable keyboard mouse and screen

hk(keyboard:=false, mouse:=0, message:="", timeout:=1, displayonce:=false,screen:=false, screencolor:="blue") {
